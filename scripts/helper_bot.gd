...
@onready var animation_player: AnimationPlayer = $SM_Veh_Mech_01/AnimationPlayer
@onready var animation_tree: AnimationTree = $SM_Veh_Mech_01/AnimationTree
@onready var character_visual: Node3D = $SM_Veh_Mech_01
